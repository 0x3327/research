...
<ul>
<li><a href="#is-hex-prefixed" class="nav-link active" data-scroll-target="#is-hex-prefixed">0.0.1 – is-hex-prefixed</a></li>
</ul>
<div class="toc-actions"><div><i class="bi bi-github"></i></div><div class="action-links"><p><a href="https://github.com/0x3327/research/edit/main/documents/research/assets/ERFC-42/research_examples/hardhat-test-example/node_modules/is-hex-prefixed/CHANGELOG.md" class="toc-action">Edit this page</a></p><p><a href="https://github.com/0x3327/research/issues/new" class="toc-action">Report an issue</a></p></div></div></nav>
    </div>
<!-- main -->
<main class="content" id="quarto-document-content">

<section id="is-hex-prefixed" class="level1">
<h1>0.0.1 – is-hex-prefixed</h1>
<ol type="1">
<li>Basic testing</li>
<li>Basic docs</li>
<li>License</li>
