...
<ul>
<li><a href="#p-locate-build-status" class="nav-link active" data-scroll-target="#p-locate-build-status">p-locate <span><img src="https://travis-ci.org/sindresorhus/p-locate.svg?branch=master" class="img-fluid" alt="Build Status"></span></a>
<ul class="collapse">
...
<ul class="collapse">
<li><a href="#plocateinput-tester-options" class="nav-link" data-scroll-target="#plocateinput-tester-options">pLocate(input, tester, <span>options</span>)</a></li>
</ul></li>
...
<div class="toc-actions"><div><i class="bi bi-github"></i></div><div class="action-links"><p><a href="https://github.com/0x3327/research/edit/main/documents/research/assets/ERFC-42/research_examples/hardhat-test-example/node_modules/mocha/node_modules/p-locate/readme.md" class="toc-action">Edit this page</a></p><p><a href="https://github.com/0x3327/research/issues/new" class="toc-action">Report an issue</a></p></div></div></nav>
    </div>
<!-- main -->
<main class="content" id="quarto-document-content">

<section id="p-locate-build-status" class="level1">
<h1>p-locate <a href="https://travis-ci.org/sindresorhus/p-locate"><img src="https://travis-ci.org/sindresorhus/p-locate.svg?branch=master" class="img-fluid" alt="Build Status"></a></h1>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true" tabindex="-1"></a><span class="kw">const</span> pathExists <span class="op">=</span> <span class="pp">require</span>(<span class="st">'path-exists'</span>)<span class="op">;</span></span>
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true" tabindex="-1"></a><span class="kw">const</span> pLocate <span class="op">=</span> <span class="pp">require</span>(<span class="st">'p-locate'</span>)<span class="op">;</span></span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a><span class="kw">const</span> files <span class="op">=</span> [</span>
<span id="cb2-5"><a href="#cb2-5" aria-hidden="true" tabindex="-1"></a>    <span class="st">'unicorn.png'</span><span class="op">,</span></span>
<span id="cb2-6"><a href="#cb2-6" aria-hidden="true" tabindex="-1"></a>    <span class="st">'rainbow.png'</span><span class="op">,</span> <span class="co">// Only this one actually exists on disk</span></span>
<span id="cb2-7"><a href="#cb2-7" aria-hidden="true" tabindex="-1"></a>    <span class="st">'pony.png'</span></span>
<span id="cb2-8"><a href="#cb2-8" aria-hidden="true" tabindex="-1"></a>]<span class="op">;</span></span>
<span id="cb2-9"><a href="#cb2-9" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-10"><a href="#cb2-10" aria-hidden="true" tabindex="-1"></a>(<span class="kw">async</span> () <span class="kw">=&gt;</span> {</span>
<span id="cb2-11"><a href="#cb2-11" aria-hidden="true" tabindex="-1"></a>    <span class="kw">const</span> foundPath <span class="op">=</span> <span class="cf">await</span> <span class="fu">pLocate</span>(files<span class="op">,</span> file <span class="kw">=&gt;</span> <span class="fu">pathExists</span>(file))<span class="op">;</span></span>
<span id="cb2-12"><a href="#cb2-12" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-13"><a href="#cb2-13" aria-hidden="true" tabindex="-1"></a>    <span class="bu">console</span><span class="op">.</span><span class="fu">log</span>(foundPath)<span class="op">;</span></span>
<span id="cb2-14"><a href="#cb2-14" aria-hidden="true" tabindex="-1"></a>    <span class="co">//=&gt; 'rainbow'</span></span>
...
<section id="plocateinput-tester-options" class="level3">
<h3 class="anchored" data-anchor-id="plocateinput-tester-options">pLocate(input, tester, <a href="#options">options</a>)</h3>
...
<section id="testerelement" class="level4">
<h4 class="anchored" data-anchor-id="testerelement">tester(element)</h4>
