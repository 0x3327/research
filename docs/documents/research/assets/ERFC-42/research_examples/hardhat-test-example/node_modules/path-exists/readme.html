...
<ul>
<li><a href="#path-exists-build-status" class="nav-link active" data-scroll-target="#path-exists-build-status">path-exists <span><img src="https://travis-ci.org/sindresorhus/path-exists.svg?branch=master" class="img-fluid" alt="Build Status"></span></a>
<ul class="collapse">
...
<ul class="collapse">
<li><a href="#pathexistspath" class="nav-link" data-scroll-target="#pathexistspath">pathExists(path)</a></li>
<li><a href="#pathexists.syncpath" class="nav-link" data-scroll-target="#pathexists.syncpath">pathExists.sync(path)</a></li>
</ul></li>
...
<div class="toc-actions"><div><i class="bi bi-github"></i></div><div class="action-links"><p><a href="https://github.com/0x3327/research/edit/main/documents/research/assets/ERFC-42/research_examples/hardhat-test-example/node_modules/path-exists/readme.md" class="toc-action">Edit this page</a></p><p><a href="https://github.com/0x3327/research/issues/new" class="toc-action">Report an issue</a></p></div></div></nav>
    </div>
<!-- main -->
<main class="content" id="quarto-document-content">

<section id="path-exists-build-status" class="level1">
<h1>path-exists <a href="https://travis-ci.org/sindresorhus/path-exists"><img src="https://travis-ci.org/sindresorhus/path-exists.svg?branch=master" class="img-fluid" alt="Build Status"></a></h1>
...
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true" tabindex="-1"></a><span class="kw">const</span> pathExists <span class="op">=</span> <span class="pp">require</span>(<span class="st">'path-exists'</span>)<span class="op">;</span></span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a><span class="fu">pathExists</span>(<span class="st">'foo.js'</span>)<span class="op">.</span><span class="fu">then</span>(exists <span class="kw">=&gt;</span> {</span>
<span id="cb2-5"><a href="#cb2-5" aria-hidden="true" tabindex="-1"></a>    <span class="bu">console</span><span class="op">.</span><span class="fu">log</span>(exists)<span class="op">;</span></span>
<span id="cb2-6"><a href="#cb2-6" aria-hidden="true" tabindex="-1"></a>    <span class="co">//=&gt; true</span></span>
<span id="cb2-7"><a href="#cb2-7" aria-hidden="true" tabindex="-1"></a>})<span class="op">;</span></span></code></pre></div>
</section>
<section id="api" class="level2">
<h2 class="anchored" data-anchor-id="api">API</h2>
<section id="pathexistspath" class="level3">
<h3 class="anchored" data-anchor-id="pathexistspath">pathExists(path)</h3>
<p>Returns a promise for a boolean of whether the path exists.</p>
</section>
<section id="pathexists.syncpath" class="level3">
<h3 class="anchored" data-anchor-id="pathexists.syncpath">pathExists.sync(path)</h3>
