...
<ul>
<li><a href="#developers-certificate-of-origin-1.1" class="nav-link active" data-scroll-target="#developers-certificate-of-origin-1.1">Developer’s Certificate of Origin 1.1</a>
<ul class="collapse">
<li><a href="#moderation-policy" class="nav-link" data-scroll-target="#moderation-policy">Moderation Policy</a></li>
<li><a href="#code-of-conduct" class="nav-link" data-scroll-target="#code-of-conduct">Code of Conduct</a></li>
</ul></li>
</ul>
<div class="toc-actions"><div><i class="bi bi-github"></i></div><div class="action-links"><p><a href="https://github.com/0x3327/research/edit/main/documents/research/assets/ERFC-42/research_examples/hardhat-test-example/node_modules/readable-stream/CONTRIBUTING.md" class="toc-action">Edit this page</a></p><p><a href="https://github.com/0x3327/research/issues/new" class="toc-action">Report an issue</a></p></div></div></nav>
    </div>
<!-- main -->
<main class="content" id="quarto-document-content">

<section id="developers-certificate-of-origin-1.1" class="level1">
...
<section id="moderation-policy" class="level2">
<h2 class="anchored" data-anchor-id="moderation-policy">Moderation Policy</h2>
