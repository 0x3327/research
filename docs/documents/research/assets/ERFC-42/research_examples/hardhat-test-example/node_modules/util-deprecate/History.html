...
<ul>
<li><a href="#section" class="nav-link active" data-scroll-target="#section">1.0.2 / 2015-10-07</a></li>
<li><a href="#section-1" class="nav-link" data-scroll-target="#section-1">1.0.1 / 2014-11-25</a></li>
<li><a href="#section-2" class="nav-link" data-scroll-target="#section-2">1.0.0 / 2014-04-30</a></li>
</ul>
<div class="toc-actions"><div><i class="bi bi-github"></i></div><div class="action-links"><p><a href="https://github.com/0x3327/research/edit/main/documents/research/assets/ERFC-42/research_examples/hardhat-test-example/node_modules/util-deprecate/History.md" class="toc-action">Edit this page</a></p><p><a href="https://github.com/0x3327/research/issues/new" class="toc-action">Report an issue</a></p></div></div></nav>
    </div>
<!-- main -->
...
<ul>
<li>use try/catch when checking <code>localStorage</code> (#3, <span class="citation" data-cites="kumavis">@kumavis</span>)</li>
</ul>
</section>
